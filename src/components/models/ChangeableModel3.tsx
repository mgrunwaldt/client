/*
  ChangeableModel3 - Component for body_type 2 (Model 3)
...
export default function ChangeableModel3({
  playerData,
  ...props
}: BaseModelProps) {
  ...
  useEffect(() => {
    const actionName = props.defaultAnimtion ?? "Bow_and_Arrow";
  ...
  // Get mesh nodes
  const bodyNode = useMemo(() => model.nodes.Body_2, [model.nodes.Body_2]);
