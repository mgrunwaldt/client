/*
  ChangeableModel1 - Component for body_type 0 (Model 1)
...
export default function ChangeableModel1({
  playerData,
  ...props
}: BaseModelProps) {
  ...
  useEffect(() => {
    ...
    // Body type 1 specific positioning
    if (key === 0) {
  ...
  // Get mesh nodes
  const bodyNode = useMemo(() => model.nodes.Body_1_1, [model.nodes.Body_1_1]);
